...
while (repeat == true){
    ...
    if (bestellingcontrolevar.includes(true) == true){
        ...
        bestellingsdict = bestellingen(bestellingvar, aantalbestellingvar,snackofgeensnack);}
    else{
...
function aantalbestelling(bestelling,snackofgeensnack){
    ...
    while (repeat == true){
        ...
        if (aantal == 8){
            ...
            aantalmandjes = prompt("Hoeveel mandjes van "+aantal+" Bitterballen wilt u?")
...
function bonnetje(bestellingdict){
    ...
    document.getElementById("antwoord").innerText += bonnetjetext+ '\n';
        for (let bestelling in bestellingdict){
            ...
            document.getElementById("antwoord").innerText += "Totaalprijs: €" + totaalprijs+ '\n';
            document.getElementById("antwoord").innerText += bonnetjetext + '\n';}
